...
import {ChartNoAxesCombined, ClipboardList, LayoutDashboard, Map, Menu, Settings} from "lucide-react";
...
export function AdminSidebar({mobile = false}: {mobile?: boolean}) {
  ...
  return (
    <aside className={cn("hidden border-r bg-card transition-all md:block", collapsed ? "w-20" : "w-64")}>
