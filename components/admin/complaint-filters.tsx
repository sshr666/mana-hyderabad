    ...
    <div className="grid gap-3 rounded-xl border bg-card p-4 md:grid-cols-4 xl:grid-cols-8">
      ...
      <Select
        ...
        onValueChange={(category) =>
          update({ category: category as ComplaintFilterState["category"] })
        }
      >
        <SelectTrigger>
      ...
      <Select
        ...
        onValueChange={(priority) =>
          update({ priority: priority as ComplaintFilterState["priority"] })
        }
      >
        <SelectTrigger>
      ...
      <Select
        value={value.status}
        onValueChange={(status) => update({ status: status as ComplaintFilterState["status"] })}
      >
        <SelectTrigger>
      ...
      <Select
        ...
        onValueChange={(language) =>
          update({ language: language as ComplaintFilterState["language"] })
        }
      >
        <SelectTrigger>
      ...
      <Select
        ...
        onValueChange={(duplicate) =>
          update({ duplicate: duplicate as ComplaintFilterState["duplicate"] })
        }
      >
        <SelectTrigger>
