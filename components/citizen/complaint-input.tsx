  ...
  return (
    <form className="space-y-4" onSubmit={handleSubmit((values) => onContinue(values.text))}>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <Button type="button" variant="outline" onClick={() => setHelper("You can take a photo in the next step after we understand the issue.")}>
          <Camera className="h-4 w-4" />
          {t("report.camera")}
        </Button>
        <Button type="button" variant="outline" onClick={() => setHelper("You can choose a gallery image in the photo step before submission.")}>
